...
Webisters Language Library This library is designed for reuse in Composer-based PHP applications.
...
## Installation
```bash
composer require webisters/language
```
...
## Documentation
- Guide: https://docs.webisters.com/guides/libraries/language/
- Package: https://webisters.com/packages/language
...
## Support
- Issues: https://github.com/webisters/language/issues
- Source: https://github.com/webisters/language
